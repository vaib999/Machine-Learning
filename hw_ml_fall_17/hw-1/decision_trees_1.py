...
df_training = pd.read_csv('dataset1/training_set.csv')#Training dataframe
df_test = pd.read_csv('dataset1/test_set.csv')#Test dataframe
df_validation = pd.read_csv('dataset1/validation_set.csv')#validation Dataset
